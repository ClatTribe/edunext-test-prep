...
export const Founders: React.FC = () => {
  return (
    <section id="founders" className="py-24 bg-[#050505] border-t border-white/5 relative overflow-hidden">
        {/* Background texture */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-2 md:order-1 relative">
             <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] bg-brand-accent/10 rounded-full blur-[80px] pointer-events-none"></div>
             <div className="relative glass-panel rounded-2xl p-8 border border-white/10 hover:border-white/20 transition-colors">
                <div className="flex items-center space-x-5 mb-6">
                  <div className="w-20 h-20 rounded-full bg-gray-800 overflow-hidden border-2 border-brand-accent shadow-xl">
                  ...
                  <div>
                    ...
                    <p className="text-brand-accent text-sm font-bold uppercase tracking-wider">Chief Mentor</p>
                  </div>
                </div>
                ...
                <div className="flex space-x-1">
                  {[1,2,3,4,5].map(i => <Star key={i} className="w-5 h-5 text-brand-accent fill-brand-accent" />)}
                </div>
             </div>
          </div>

          <div className="order-1 md:order-2">
            <h2 className="text-4xl font-bold text-white mb-6 leading-tight">From IPM AIR 1 to <br/><span className="text-brand-accent">JEE Domination</span></h2>
