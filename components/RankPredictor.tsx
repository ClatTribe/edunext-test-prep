...
export const RankPredictor: React.FC = () => {
  ...
  return (
    <section id="analytics" className="py-24 bg-[#080808] relative overflow-hidden">
       {/* Background */}
       <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-purple-900/10 rounded-full blur-[128px] pointer-events-none"></div>
       <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-brand-accent/5 rounded-full blur-[100px] pointer-events-none"></div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">Don't Guess. <span className="text-brand-accent">Know.</span></h2>
        ...
        <div className="glass-panel max-w-5xl mx-auto rounded-3xl p-8 md:p-12 border border-white/10 shadow-2xl relative z-10">
            ...
            <div className="space-y-10">
              <div>
                ...
                <input 
                  ...
                  className="w-full h-3 bg-gray-800 rounded-lg appearance-none cursor-pointer accent-brand-accent hover:accent-brand-accentHover transition-all focus:outline-none focus:ring-2 focus:ring-brand-accent/50"
                />
              ...
              <div className="p-5 bg-gradient-to-r from-brand-accent/10 to-transparent rounded-xl border-l-4 border-brand-accent">
                <div className="flex items-start">
                  <Target className="w-5 h-5 text-brand-accent mt-0.5 flex-shrink-0" />
            ...
            <div className="flex flex-col justify-center items-center text-center space-y-8 bg-white/5 p-8 rounded-2xl border border-white/5">
              ...
              <div className="grid grid-cols-2 gap-4 w-full border-t border-white/10 pt-6">
                <div className="text-center p-3 rounded-lg hover:bg-white/5 transition-colors">
                  ...
                  <div className="text-xl font-bold text-brand-accent font-mono">{Number(percentile) > 0 ? percentile : '0.00'}%ile</div>
                </div>
                <div className="text-center p-3 rounded-lg hover:bg-white/5 transition-colors">
              ...
              <button className="text-sm text-brand-accent hover:text-white flex items-center transition-colors group">
