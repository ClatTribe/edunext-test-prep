  ...
  return (
    <section className="relative min-h-screen flex items-center pt-24 pb-12 overflow-hidden bg-brand-dark">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-brand-accent/5 rounded-full blur-[120px] pointer-events-none mix-blend-screen animate-pulse-slow"></div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="flex flex-col items-start text-left">
            ...
            <div className="mb-8 animate-slide-up" style={{animationDelay: '0.1s'}}>
               <div className="inline-flex items-center space-x-2 bg-white/5 border border-white/10 rounded-full px-3 py-1.5 backdrop-blur-md">
            ...
            <h1 className="text-5xl lg:text-7xl font-black tracking-tighter text-white mb-6 leading-tight max-w-2xl animate-slide-up" style={{animationDelay: '0.2s'}}>
              The Science of <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-accent via-yellow-200 to-brand-accent animate-shine bg-[length:200%_auto]">Toppers.</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-6 animate-slide-up mb-12" style={{animationDelay: '0.4s'}}>
              ...
              <button onClick={() => window.location.hash = 'analytics'} className="flex items-center text-gray-300 hover:text-white transition-colors group w-full sm:w-auto justify-center sm:justify-start">
                  <div className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center mr-3 group-hover:bg-brand-accent group-hover:text-brand-dark transition-all">
            ...
            {/* Credentials Bar */}
            <div className="grid grid-cols-4 gap-4 w-full border-t border-white/10 pt-8 animate-slide-up" style={{animationDelay: '0.5s'}}>
               <div>
          ...
          <div className="relative animate-slide-up" style={{animationDelay: '0.6s'}}>
             <div className="absolute -inset-1 bg-gradient-to-tr from-brand-accent to-purple-600 rounded-2xl blur opacity-20 animate-pulse-slow"></div>
             
             <div className="relative bg-[#0F0F0F] border border-white/10 rounded-2xl overflow-hidden shadow-2xl flex flex-col">
                {/* Image Area */}
                <div className="relative h-64 sm:h-80 w-full overflow-hidden">
                   <div className="absolute inset-0 bg-gradient-to-t from-[#0F0F0F] via-[#0F0F0F]/20 to-transparent z-10"></div>
                   <img 
                ...
                {/* Login Area */}
                <div className="p-8 pt-6 bg-[#0F0F0F] relative z-20">
                   ...
                   <button className="w-full bg-white text-gray-900 font-bold py-3.5 px-4 rounded-lg flex items-center justify-center space-x-3 hover:bg-gray-100 transition-all shadow-lg hover:shadow-white/10 active:scale-[0.98]">
