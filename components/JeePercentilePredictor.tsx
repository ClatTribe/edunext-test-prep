...
export const JeePercentilePredictor: React.FC = () => {
  ...
  return (
    <section id="jee-predictor" className="py-24 bg-[#0A0A0A] border-t border-white/5 relative overflow-hidden">
        {/* Glow effects */}
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
            <div className="inline-flex items-center px-3 py-1 rounded-full bg-brand-accent/10 text-brand-accent text-xs font-bold uppercase tracking-wider mb-4 border border-brand-accent/20">
                New Feature
            </div>
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">JEE Jan 2026 <span className="text-brand-accent">Rank Predictor</span></h2>
        ...
        <div className="bg-[#111] rounded-3xl border border-white/10 p-8 md:p-12 shadow-2xl relative z-10 overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 relative z-10">
                ...
                <div className="space-y-10">
                    <div className="grid grid-cols-2 gap-6">
                        <div>
                            ...
                            <select 
                                ...
                                className="w-full bg-[#1A1A1A] text-white border border-white/10 rounded-lg px-4 py-3 focus:outline-none focus:border-brand-accent transition-colors appearance-none cursor-pointer"
                            >
                    ...
                    <div>
                        <div className="flex justify-between items-end mb-6">
                            ...
                            <div className="bg-[#1E1E1E] px-5 py-2 rounded-lg border border-white/10 flex items-baseline">
                        ...
                        <input 
                            ...
                            className="w-full h-2 bg-gray-800 rounded-lg appearance-none cursor-pointer accent-brand-accent hover:accent-brand-accentHover transition-all"
                        />
                    ...
                    <div className="bg-gradient-to-r from-yellow-500/10 to-transparent border-l-4 border-yellow-500 p-5 rounded-r-lg">
                        <div className="flex items-start gap-4">
                            <div className="mt-1 bg-yellow-500/20 p-2 rounded-full flex-shrink-0">
                ...
                {/* Right Column: Output */}
                <div className="bg-[#151515] rounded-2xl border border-white/5 p-8 flex flex-col justify-center items-center text-center shadow-inner relative">
                    ...
                    <button className="mt-8 text-brand-accent hover:text-white text-sm font-medium flex items-center transition-colors group">
